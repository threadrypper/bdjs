 ...
 */
export type CompileDataType<T extends DataType = DataType> = T extends DataType.Boolean ? boolean : T extends DataType.Number ? number : T extends DataType.String ? string : unknown;
/**
